...
export const msalConfig = {
    auth: {
        ...
        redirectUri: "/", // You must register this URI in your Azure AD app registration
        postLogoutRedirectUri: "/",
    },
    cache: {
        cacheLocation: "sessionStorage", // This configures where your cache will be stored
        storeAuthStateInCookie: false, // Set to true if you are having issues in IE11 or Edge
    },
    system: {
        loggerOptions: {
